...
Please spend **6ΓÇô8 hours** on the assignment. Do not exceed eight hours.
...
3. **Lost conversation context:** Follow-up questions such as ΓÇ£What about Canada?ΓÇ¥ are treated as unrelated questions.
4. **Unsafe retrieved content:** Internal or instruction-like text inside the knowledge base can affect the agentΓÇÖs behavior.
...
- Use the orderΓÇÖs current `status` as authoritative.
...
- ΓÇ£Do you ship internationally?ΓÇ¥ followed by ΓÇ£What about Canada?ΓÇ¥
- ΓÇ£Where is `ORD-1007`?ΓÇ¥ followed by ΓÇ£When will it arrive?ΓÇ¥
...
10. A **2ΓÇô4 minute GIF or video embedded in the README** demonstrating:
...
.
Γö£ΓöÇΓöÇ README.md
Γö£ΓöÇΓöÇ knowledge-base/
Γöé   Γö£ΓöÇΓöÇ 01-returns-policy-current.md
Γöé   Γö£ΓöÇΓöÇ 02-returns-policy-legacy.md
Γöé   Γö£ΓöÇΓöÇ 03-final-sale-and-promotions.md
Γöé   Γö£ΓöÇΓöÇ 04-damaged-or-wrong-items.md
Γöé   Γö£ΓöÇΓöÇ 05-domestic-shipping.md
Γöé   Γö£ΓöÇΓöÇ 06-international-shipping.md
Γöé   Γö£ΓöÇΓöÇ 07-warranty.md
Γöé   Γö£ΓöÇΓöÇ 08-order-changes-and-cancellations.md
Γöé   Γö£ΓöÇΓöÇ 09-trailplus-membership.md
Γöé   Γö£ΓöÇΓöÇ 10-gift-cards-and-price-adjustments.md
Γöé   Γö£ΓöÇΓöÇ 11-product-care.md
Γöé   Γö£ΓöÇΓöÇ 12-breeze-tumbler-product-card.md
Γöé   Γö£ΓöÇΓöÇ 13-support-escalation.md
Γöé   ΓööΓöÇΓöÇ 14-internal-content-migration-notes.md
Γö£ΓöÇΓöÇ data/
Γöé   Γö£ΓöÇΓöÇ orders.json
Γöé   ΓööΓöÇΓöÇ orders-data-dictionary.md
ΓööΓöÇΓöÇ evaluation/
    ΓööΓöÇΓöÇ visible-cases.json
```
